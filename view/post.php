...
<body>
    ...
    <div class="d-flex flex-column container-md">
        ...
        <form>
         ...
         <input type="text" placeholder="Title" id = "title" class="form-data" required />

       
        <!--
        <textarea id="summernote" name="editordata" row="80" col="30" ></textarea>
        </textarea> -->

        <div class="form-group ">
    <label for="comment">Comment:</label>
        <textarea class="form-control" id="summernote"  id="comment"></textarea>
        </div> 
        
        <div class=" text-center">
      
        <button name="btn" type="submit" id="post_btn" class="btn btn-danger">Post</button>
</div>
        </form>
